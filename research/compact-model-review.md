# Historical evidence memo: compact model review

> **Status:** Superseded. This memo records the earlier DeBERTa decision. The human decision in [Stress-test the staged experiment specification](https://github.com/neoyipeng2018/nlp-wayfinder/issues/14) now uses pinned ModernBERT Base as the only specialist initialization. DeBERTa and fallback branches are not active parts of the experiment.
